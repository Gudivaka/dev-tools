    ...
    <div className="space-y-6">
      ...
      <div className="p-4 rounded-2xl bg-gray-900/80 border border-gray-800 space-y-3">
        <label className="block text-xs font-semibold text-gray-300 flex items-center gap-2">
          <Globe className="w-4 h-4 text-indigo-400" /> Enter Full URL or String
        </label>
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-4 py-2.5 text-xs font-semibold rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white whitespace-nowrap"
          >
            Encode
          </button>
          <button
            onClick={() => setUrlInput(decodeText(urlInput))}
            className="px-4 py-2.5 text-xs font-semibold rounded-xl bg-gray-800 hover:bg-gray-700 text-gray-200 border border-gray-700 whitespace-nowrap"
          >
            Decode
          </button>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-gray-900/80 border border-gray-800 space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-xs font-semibold text-gray-200 flex items-center gap-2">
              <Link className="w-4 h-4 text-emerald-400" /> Query String Parameters ({parsedInfo.params.length})
            </h3>
            <button
              onClick={handleAddParam}
              className="flex items-center gap-1 px-3 py-1 text-xs font-medium rounded-lg bg-emerald-500/10 text-emerald-400 border border-emerald-500/20"
            >
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-xs font-mono text-left border-collapse">
              <thead>
                <tr className="border-b border-gray-800 text-gray-400 font-sans">
                  ...
                  <tr key={index}>
                    <td className="py-2 px-3">
                      <input
                        ...
                        className="w-full glass-input px-2 py-1 rounded text-xs font-mono text-indigo-300"
                      />
                    </td>
                    <td className="py-2 px-3">
                      <input
                        ...
                        className="w-full glass-input px-2 py-1 rounded text-xs font-mono text-emerald-300"
                      />
                    </td>
